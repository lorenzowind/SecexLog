...
const Routes = () => (
  <BrowserRouter>
    <Switch>
      ...
      <PrivateRoutes exact path="/cadastro/cidade/create" component={CrudCidade} />
      <PrivateRoutes exact path="/cadastro/feriado/create" component={CrudFeriado} />
      <PrivateRoutes exact path="/cadastro/modal/create" component={CrudModal} />
      <PrivateRoutes exact path="/cadastro/prestador/create" component={CrudPrestador} />
      <PrivateRoutes exact path="/cadastro/trajeto/create" component={CrudTrajeto} />
