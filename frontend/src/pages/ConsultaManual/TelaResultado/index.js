    ...
    validation = () => {
        ...
        for(var i=0;i<this.state.trajetos.length;i++){
            ...
            for(var j=0;j<this.state.paths.length;j++){
                ...
                if(aux[i].cidadeIda === this.state.paths[j].initCidade && aux[i].cidadeVolta === this.state.paths[j].endCidade){
                    aux[i].exists = true;
                    ...
                    <div className="trajeto" key={i.cidadeIda+"-"+i.cidadeVolta}>
                        ...
                        <div className="linha-2">
                            <div className="filtros">
                                <div className="rapidoIcone"><img src={rapidoIcone} alt=""/></div>
                                <div className="custoIcone"><img src={custoIcone} alt=""/></div>
                                <div className="seguroIcone"><img src={seguroIcone} alt=""/></div>
                            </div>
                            <div className="cidades">
                                <div className="cidadeIda"><h1>{i.cidadeIda}</h1></div>
                                <div className="cidadeVolta"><h1>{i.cidadeVolta}</h1></div>
                            </div>
                            <div className="periodo">
                                <div className="data"><h1>{i.data}</h1></div>
                            </div>
                        ...
                        {i.path_id.map((t) => (
                            <div className="linha-3">
                                <div className="cartao_trajeto">
                                    <div className="imagem_modal"><h1>{t.modal}</h1></div>
                                    <div className="linha-4">
                                        <div className="horarioSaida"><h1>{t.hora[0]}, {t.dia[0]}</h1></div>
                                        <div className="cidadeSaida"><h1>{t.initCidade}</h1></div>
                                        <div className="modalSaida"><h1>{t.modal}</h1></div>
                                        <div className="duracao"><h1>{t.duration}</h1></div>
                                        <div className="barraIcone2"><img src={barraIcone2} alt=""/></div>
                                        <div className="horarioDestino"><h1>{t.dia[0]}</h1></div>
                                        <div className="cidadeDestino"><h1>{t.endCidade}</h1></div>
                                        <div className="modalDestino"><h1>{t.modal}</h1></div>
                                        <div className="idaIcone"><img src={idaIcone} alt=""/></div>
                                        <div className="linha_vertical"/>
                                        <div className="preco"><h1>{t.cost}</h1></div>
                                        <div className="botao_selecionar"><img src={botaoSelecionar} alt="" onClick={this.evento_selecionar}/></div>
                                    </div>
                                </div>
                            </div>
                        ))}
                        ...
                        <div className="nenhum_trajeto">
                            ...
                            <div className="msg"><h1>Nenhum trajeto encontrado</h1></div>
                            </div>
                        </div>
                        )}
                    </div>
