...
import TelaOpiniao from "../../components/TelaOpiniao/index";
        ...
        return (
            <div className="header">
                ...
                <div className="de-sua-opiniao">
                    <h1 id="de_sua_opiniao" onClick={this.evento_opiniao}>Dê sua Opinião</h1>
                </div>

                <div className="login">
                    <h1 id="login" onClick={this.evento_login}>Login</h1>
                </div>

                <div className="logo_tce">
                    <img src={tce_logo} alt="logo tce"/>
                </div>
